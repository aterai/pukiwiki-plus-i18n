        ...
        function hash($str, $ig_func = false)
        {
            ...
            for ($i = 0; $i < $N; $i++) {
                ...
                for ($t = 0; $t < 16; $t++) {
                    ...
                    $_T1 = $this->addmod2n(
                        $this->addmod2n(
                            $this->addmod2n($this->addmod2n($_h, $this->Sigma1($_e)), $this->Ch($_e, $_f, $_g)),
                            $K[$t],
                        ),
                        $W[$t],
                    );
                ...
                for (; $t < 64; $t++) {
                    ...
                    $W[$t & 0xF] = $this->addmod2n(
                        $this->addmod2n($this->addmod2n($W[$t & 0xF], $_s0), $_s1),
                        $W[($t + 9) & 0x0F],
                    );
    ...
    function str_split($string, $split_length = 1)
    {
        ...
        if ($split_length == 0 || $strlen == 0) {
            ...
            for ($i = 0; $i < $strlen; $i++) {
                ...
                $length = ($i + $split_length) > $strlen ? ($strlen - ($i + 1)) : $split_length;
            }
        }
