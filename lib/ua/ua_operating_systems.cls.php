...
class ua_operating_systems
{
    var $OSHashID = array(
        // Windows OS family
        array('windows[_+ ]?2005',       'winlong'),
        // winlong.png
        array('windows[_+ ]nt[_+ ]6\.0', 'winlong'),
        array('windows[_+ ]?2003',       'win2003'),
        // win2003.png
        array('windows[_+ ]nt[_+ ]5\.2', 'win2003'),
        array('windows[_+ ]xp',          'winxp'),
        // winxp.png
        array('windows[_+ ]nt[_+ ]5\.1', 'winxp'),
        array('windows[_+ ]me',          'winme'),
        // winme.png
        array('win[_+ ]9x',              'winme'),
        array('windows[_+ ]?2000',       'win2000'),
        // win2000.png
        ...
        // wince.png
        // Macintosh OS family
        array('mac[_+ ]os[_+ ]x',        'macosx'),
        // macosx.png
        array('mac[_+ ]?p',              'macintosh'),
        // macintosh.png
        ...
        array('gnu.kfreebsd',            'bsdkfreebsd'),
        // Must be before freebsd
        ...
        // dreamcast.png
        array('risc[_+ ]?os',            'riscos'),
        // riscos.png
        array('symbian',                 'symbian'),
        // symbian.png
        array('webtv',                   'webtv'),
        // webtv.png
        array('playstation\sportable',   'psp'),
        // psp.png
        array('xbox',                    'xbox'),
        // xbox.png
    );
