...
require_once 'ccTLD.cls.php';
// ccTLD (country code TLD) / TopLevelDomain
require_once 'ua_browsers.cls.php';
// Browser
require_once 'ua_operating_systems.cls.php';
// OS
require_once 'robots.cls.php';
