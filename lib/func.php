...
function is_interwiki($str): false|int
{
    global $InterWikiName;
    return preg_match('/^' . $InterWikiName . '$/', $str);
}

function is_pagename($str): bool
{
    global $BracketName;
...
function is_cantedit($page): bool
{
    global $cantedit;
    static $is_cantedit;
...
function is_editable($page): bool
{
...
function check_non_list($page = ''): false|int
{
    global $non_list;
    static $regex;
...
// Auto template
function auto_template($page): array|string|null
{
...
function sanitize($param): array|string
{
