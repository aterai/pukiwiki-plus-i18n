...
class timezone
{
    ...
    function calc_dst($rule_name)
    {
        ...
        foreach ($this->dst as $x) {
            ...
            if (!empty($tbl[$idx_dst]) && $tbl[$idx_dst][1] != 9999)
                continue; // 日付固定分のため優先
