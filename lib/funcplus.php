...
function basepagename($str): array|string|null
{
    return mb_basename($str);
}

// multibyte supported 'basename' function
function mb_basename($str): array|string|null
{
    return preg_replace('#^.*/#', '', $str);
}

// SPAM check
function is_spampost($array, $count = 0): bool
{
    global $vars;
    $encount = 0;
    if ($count <= 0) {
...
function is_ignore_page($page): bool
{
...
function init_script_filename(): string
{
