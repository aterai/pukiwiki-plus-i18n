...
function plugin_calendar_convert()
{
    ...
    $calendar_head .=
        '   <a href="' .
        get_cmd_uri(PLUGIN_CALENDAR_ACTION, '', '', 'file=' . $r_base . '&date=' . $prev_date_str . '&mode=' . $mode) .
        '">&lt;&lt;</a>' .
        "\n" .
        '   <strong>' .
        $m_name .
        ...
        "\n" .
        '   <a href="' .
        get_cmd_uri(PLUGIN_CALENDAR_ACTION, '', '', 'file=' . $r_base . '&date=' . $next_date_str . '&mode=' . $mode) .
        '">&gt;&gt;</a>';
    ...
    if ($prefix) {
        $calendar_head .=
            ...
            '[<a href="' .
            get_cmd_uri(
                PLUGIN_CALENDAR_ACTION,
                '',
                '',
                'file=' . $r_base . '&date=' . $this_date_str . '&mode=' . $mode,
            ) .
            '">' .
            $s_base .
            '</a>]';
    ...
    while (checkdate($m_num, $day, $y_num)) {
        ...
        if (is_page($page)) {
            ...
            $link =
                '<a href="' .
                get_cmd_uri('edit', $page, '', 'refer=' . $base) .
                '" title="' .
                $s_page .
                '">' .
                $day .
