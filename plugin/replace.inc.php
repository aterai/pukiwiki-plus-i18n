...
const REPLACE_IGNORE_FREEZE = true;

function plugin_replace_init(): void
{
    // global $_replace_msg;
    $messages = array(
        '_replace_msg' => array(
...
function plugin_replace_action(): array
{
...
function replace_do($search, $replace, $notimestamp): array
{
    global $cycle, $cantedit, $vars;
    global $_replace_msg;
...
// 置換文字列入力画面
function replace_adm($pass, $search): array
{
    global $_replace_msg;
    global $script;
    global $_button;
