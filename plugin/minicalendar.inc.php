    ...
    if (!defined('UA_MOBILE') || UA_MOBILE == 0) {
        if ($today_view) {
            if (exist_plugin('topicpath')) {
                $ret =
                    "<div id=\"topicpath\"><a href=\"" .
                    $script .
                    "\">" .
                    PLUGIN_TOPICPATH_TOP_LABEL .
                    '</a>' .
                    PLUGIN_TOPICPATH_TOP_SEPARATOR .
                    'calendar - ' .
                    $s_base .
                    "</div>\n";
            }
        ...
        while (checkdate($m_num, $day, $year)) {
            ...
            if (is_page($page)) {
                $link =
                    "<a class=\"small\" href=\"" .
                    get_page_uri($page) .
                    "\" title=\"$s_page\"><strong>$day</strong></a>";
            } else {
        ...
        if ($today_view) {
            if ($today_args == '') {
                ...
                if (is_page($tpage)) {
                    ...
                    $str = sprintf(
                        $_minicalendar_plugin_empty,
                        make_pagelink(sprintf(
                            '%s%4d-%02d-%02d',
                            $prefix,
                            $today['year'],
                            $today['mon'],
        ...
        while (checkdate($m_num, $day, $year)) {
            ...
            if (is_page($page)) {
                ...
                $link =
                    "$spc<a class=\"small\" href=\"" .
                    get_page_uri($page) .
                    "\" title=\"$s_page\"><font color=\"red\">$day</font></a>";
            } else {
                if ($day < 10) {
                    $spc = '&nbsp;';
                } else {
