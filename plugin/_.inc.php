...
function i18n_TempMsg($parm_lang_split, $view_lang_split, $msg)
{
    ...
    if ($key === false)
        return '';
    if (!empty($i18n_temp_msg[$key][$view_lang_split[0]]))
        return $i18n_temp_msg[$key][$view_lang_split[0]];
    if (!empty($i18n_temp_msg[$key][$view_lang_split[1]]))
        return $i18n_temp_msg[$key][$view_lang_split[1]];
    return '';
}
