...
// $Id: calendar_viewer.inc.php,v 1.36.9 2008/02/24 18:48:00 upk Exp $
// Copyright (C)
...
function plugin_calendar_viewer_convert()
{
    ...
    if ($dir = @opendir(DATA_DIR)) {
        ...
        while ($file = readdir($dir)) {
            ...
            if (
                plugin_calendar_viewer_isValidDate($page_date, $date_sep) == false ||
    ...
    if ($left_YM != '' || $right_YM != '') {
        ...
        $link = get_cmd_uri(
            ...
            '',
            '',
            'mode=' . $mode . '&file=' . $enc_pagename . '&date_sep=' . $s_date_sep,
        );
        if ($left_YM != '')
        ...
        $return_body .=
            ...
            '<span class="calendar_viewer_left">' .
            $left_link .
            '</span>' .
            '<span class="calendar_viewer_right">' .
            $right_link .
            '</span>' .
            '</div>';
    }
