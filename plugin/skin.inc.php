 ...
 *
 */
defined('PLUGIN_SKIN_USE') or define('PLUGIN_SKIN_USE', 1);
// skin プラグインの機能の利用可否 (1-ok, 0-ng)
defined('PLUGIN_SKIN_EXPIRE') or define('PLUGIN_SKIN_EXPIRE', 0);
...
function plugin_skin_action()
{
    ...
    if (!PLUGIN_SKIN_USE)
        return array('msg' => $_skin_msg['msg_select'], 'body' => $_skin_msg['err_not_use']);
    if (empty($post['skin']))
