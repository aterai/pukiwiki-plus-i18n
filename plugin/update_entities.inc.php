    ...
    $messages = array(
        '_entities_messages' => array(
            ...
            'msg_usage1' =>
                    ...
                    _(
                        ":The cache of the regular expression pattern that matches to the Character entity references is updated.|\n",
                    ) .
...
function plugin_update_entities_create($do = false)
{
    ...
    ($fp = fopen(CACHE_DIR . PKWK_ENTITIES_REGEX_CACHE, 'w')) or
        die_message('cannot write file PKWK_ENTITIES_REGEX_CACHE<br />' .
            "\n" .
