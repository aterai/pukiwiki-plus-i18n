...
function passwd_menu($msg = '&nbsp;')
{
    ...
    if ($role_level == 2) {
        ...
        if ($role_level == 0) {
            ...
            $a1_des =
                'a1 = objForm.username.value+\':\'+decodeURIComponent(objForm.realm.value)+\':\'+objForm.key.value;' .
                "\n";
        }
    ...
    switch ($auth_type) {
        ...
        default:
            ...
            $a1 =
                'a1 = objForm.username.value+\':\'+decodeURIComponent(objForm.realm.value)+\':\'+objForm.passwd.value;' .
                "\n";
            $checked_md5 = 'checked="checked"';
            $checked_sha1 = '';
