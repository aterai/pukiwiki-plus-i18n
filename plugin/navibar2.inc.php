...
defined('NAVIBAR2_DEFAULT_PARM') or
    define('NAVIBAR2_DEFAULT_PARM', 'top,list,search,recent,help,|,new,edit,upload,|,trackback');
        ...
        if ($head == '-') {
            if ($level == 1) {
                ...
                if ($rc) {
                    ...
                    $rep .= '</a>';
                    $menubar[$menubarcount] =
                        ' <td class="navimenu" id="navimenutd' .
                        $menubarcount .
                        '">' .
                    ...
                    if (isset($interkey['url'])) {
                        ...
                        $menubar[$menubarcount] =
                            ...
                            '<a href="' .
                            $interkey['url'] .
                            '" class="navimenu" id="NaviMenuLink' .
                            $menubarcount .
                            '">' .
                            $interkey['text'] .
                            '</a></td>';
                ...
                if ($rc) {
                    ...
                    $rep .= '</a>';
                    $menublk[$menubarcount][] =
                        ' <div class="MenuItem">' . str_replace('__navibar2__', $rep, $conv) . '</div>';
                } else {
...
{
    $conv = preg_replace(array("'<p>'si", "'</p>'si"), array('', ''), convert_html(array($str)));
...
function _navigator2($key, $val = '')
{
    ...
    if (!isset($link[$key])) {
        return array('text' => '<!--LINK NOT FOUND-->');
    }
    if (!isset($lang[$key])) {
        return array('text' => '<!--LANG NOT FOUND-->');
    }
