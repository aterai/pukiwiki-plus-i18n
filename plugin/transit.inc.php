...
function plugin_transit_inline()
{
    ...
    $result =
        '<form action="http://transit.yahoo.co.jp/bin/exp" target="transit" method="POST" accept-charset="euc-jp" onsubmit="' .
        "document.charset='euc-jp'; return true;" .
        '">' .
        $s_closet .
        $s_station .
        $s_to .
        ...
        '<input type="hidden" name="val_to" value="' .
        $s_station .
        '">' .
