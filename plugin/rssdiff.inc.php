...
function plugin_rssdiff_output_rss2()
{
    ...
    $description = htmlspecialchars(mb_convert_encoding(
        PLUGIN_RSSDIFF_DESCRIPTION,
        PLUGIN_RSSDIFF_OUTPUT_ENCODING,
        SOURCE_ENCODING,
    ));
...
class plugin_rssdiff_item
{
    ...
    function make_description()
    {
        ...
        if (strlen($description) > PLUGIN_RSSDIFF_MAX_DESCRIPTION_SIZE) {
            $description = mb_strimwidth(
                $description,
                0,
                PLUGIN_RSSDIFF_MAX_DESCRIPTION_SIZE,
                '...',
                PLUGIN_RSSDIFF_OUTPUT_ENCODING,
            );
        }
    ...
    function make_line($line)
    {
        ...
        return (
            "<$tag[$diff]><code>" .
            htmlspecialchars(mb_convert_encoding($str, PLUGIN_RSSDIFF_OUTPUT_ENCODING, SOURCE_ENCODING)) .
            "</code></$tag[$diff]>"
        );
    } // End of make_line()
