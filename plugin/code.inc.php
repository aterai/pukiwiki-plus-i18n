...
//     }
    ...
    if ($flag) {
        $git = 'https://github.com/aterai/java-swing-tips/blob/main/examples/' . str_replace('Swing/', '', $page) . '/src/java/example/MainPanel.java';
        $kotlin = 'https://github.com/aterai/kotlin-swing-tips/blob/main/examples/' . str_replace('Swing/', '', $page) . '/src/main/kotlin/example/App.kt';
        ...
        return '<div style="position:relative">' . $pre . '<span style="position:absolute;right:1.5EM;top:-1.5EM;z-index:50">View in GitHub: <a href="' . $git . '">Java</a>, <a href="' . $kotlin . '">Kotlin</a></span></div>';
    }else{
        return $pre;
    }
}
