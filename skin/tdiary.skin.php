...
if (
    defined('TDIARY_TITLE_DESIGN_DATE') &&
        (TDIARY_TITLE_DESIGN_DATE == 0 || TDIARY_TITLE_DESIGN_DATE == 1 || TDIARY_TITLE_DESIGN_DATE == 2)
) {
...
if (defined('TDIARY_SIDEBAR_POSITION')) {
    ...
    switch (TDIARY_THEME) {
        ...
        case 'cosmos':
        case 'dice':
        // Sidebar text (white) seems unreadable
        case 'happa':
        case 'kaeru':
        case 'note':
        case 'paper':
        ...
        case 'sunset':
        case 'tinybox':
        // For MSIE with narrow window width, seems meanless
        case 'tinybox_green':
        // The same
        case 'ymck':
            $sidebar = 'top';
        ...
        case 'mono':
        case 'moo':
        // For MSIE, strict seems meanless
        case 'navy':
        case 'pict':
        case 'pokke-blue':
        case 'pokke-orange':
...
<?php if (PKWK_ALLOW_JAVASCRIPT && isset($javascript)) { ?> <meta http-equiv="Content-Script-Type" content="text/javascript" /><?php } ?>
 ...
 <link rel="stylesheet" type="text/css" media="all" href="<?php echo
     SKIN_URI . THEME_TDIARY_NAME . $theme . '/' . $theme . '.css'
 ; ?>" />
 <link rel="stylesheet" type="text/css" media="screen" href="<?php echo SKIN_URI ?>tdiary.css.php?charset=<?php echo
     $css_charset
  ?>&amp;color=<?php echo $css_theme ?>" charset="<?php echo $css_charset ?>" />
 <link rel="stylesheet" type="text/css" media="print"  href="<?php echo SKIN_URI ?>tdiary.css.php?charset=<?php echo
     $css_charset
  ?>&amp;color=<?php echo $css_theme ?>&amp;media=print" charset="<?php echo $css_charset ?>" />
...
$body = preg_replace(
    '#<h2 ([^>]*)>(.*?)<a class="anchor_super" ([^>]*)>.*?</a></h2>#',
    '<h3 $1><a $3><span class="sanchor">_</span></a> $2</h3>',
    $body,
);
$body = preg_replace(
    '#<h([34]) ([^>]*)>(.*?)<a class="anchor_super" ([^>]*)>.*?</a></h\1>#',
    '<h$1 $2><a $4>_</a> $3</h$1>',
    $body,
);
		...
		echo
    		preg_replace(
        		...
        		'<div class="commentator"><a $1><span class="canchor"></span> ' .
            		...
            		'<span class="commenttime"></span></div>',
        		$notes,
    		)
		;
		?>
...
<div class="referer"><?php if ($lastmodified != '')
    echo 'Last-modified: ' . $lastmodified; ?></div>
