...
//
// $Id: iridorange.skin.php,v 1.1.15 2009/04/04 03:20:00 upk Exp $
// Original is ari-
//

// 使用するスタイル
$irid_style_name = 'iridorange';
...
<?php } ?>
 <link rel="stylesheet" href="<?php echo
     SKIN_URI . THEME_PLUS_NAME . $irid_style_name . '/' . $irid_style_name . '.css'
  ?>" title="<?php echo $irid_style_name ?>" type="text/css" charset="<?php echo $css_charset ?>" />
...
<div>
	...
	<input type="radio" name="type" value="AND" checked="checked" id="and_search" /><label for="and_search">AND <?php echo
    	$lang['search']
	 ?></label>
